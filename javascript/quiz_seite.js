...
function konsole() {
    console.log(document.getElementById("whiteout").style.opacity);
}
...
function checkTime() {
	...
	if(total_seconds <= 0) {
        showScore();
        document.getElementById("contain").style.opacity = 0.12;
        document.getElementsByClassName("container").classList.add('containertwo');
	}
	else {
